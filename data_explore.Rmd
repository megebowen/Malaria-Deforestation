...
#download_tiles(tiles, output_folder = "tiles_subset", dataset = "GFC-2018-v1.6")

#subset of subset
output_folder <- "."
download_tiles(tiles[2], output_folder = ".", dataset = "GFC-2018-v1.6")
...
lossyear <- raster("Hansen_GFC-2018-v1.6_lossyear_00N_070W.tif")

treecover2000 <- raster("Hansen_GFC-2018-v1.6_treecover2000_00N_070W.tif")
...
filter2001 <- mask(subsetclip, filter_2001)

filter_2002 <- subsetclip %in% 1:2
filter2002 <- mask(subsetclip, filter_2002)

##mini extent
ext <- extent(c(-67.1, -67, -10, -9.9))
plot(filter_2001, ext= ext,
     main="2001")
plot(filter_2002, ext= ext,
     main="2001-2002")

filter_2001 <- mask(subsetclip, filter_2001)
