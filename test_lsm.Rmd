...
- mean patch size: interesting for loss in the year (mean patch size of forest loss) and total forest loss
- edge density
- total cover
- patch clumpiness: is loss happening in distinct patterns? or randomly across the landscape?
